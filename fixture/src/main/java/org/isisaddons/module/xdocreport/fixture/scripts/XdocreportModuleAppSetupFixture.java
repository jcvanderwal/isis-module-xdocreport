...
public class XdocreportModuleAppSetupFixture extends FixtureScript {

    public XdocreportModuleAppSetupFixture() {
    ...
    protected void execute(ExecutionContext executionContext) {
        ...
        // prereqs
        execute(new XdocreportModuleAppTeardownFixture(), executionContext);
