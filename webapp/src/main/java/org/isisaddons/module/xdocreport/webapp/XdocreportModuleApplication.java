 ...
 *  under the License.
 */
package org.isisaddons.module.xdocreport.webapp;
 ...
 * 
 */
public class XdocreportModuleApplication extends IsisWicketApplication {
    ...
    private static final String APP_NAME = "Xdocreport Module Example App";
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                // bind(AppManifest.class).toInstance(new XdocreportAppAppManifest());
            }
        };
